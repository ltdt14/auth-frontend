	            ...
	            switch (options.action) {
	                ...
	                case actions.createItem:
	                    try {
	                        ...
	                        _uikitsaveimport.SaveUIkit.notification(err.message);
	                    }
	                    if (res.data.success) _this2.request({ action: actions.lists });else _uikitsaveimport.SaveUIkit.notification({
	                        message: res.data.msg,
	                        status: 'danger',
	                        pos: 'top-center',
	                        timeout: 3000
...
//# sourceMappingURL=component---src-pages-user-js-2fd66a33fd5624d83214.js.map