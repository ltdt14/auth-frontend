...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _BrowserStyleSheet = __webpack_require__(170);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _isFunction = __webpack_require__(140);
	...
	var _once = __webpack_require__(180);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _withTheme = __webpack_require__(169);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _interleave = __webpack_require__(178);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _domElements = __webpack_require__(174);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _extractCompsFromCSS = __webpack_require__(175);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _getComponentName = __webpack_require__(177);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _stylis = __webpack_require__(183);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
		 true ? module.exports = factory(__webpack_require__(142)) :
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _gatsbyLink = __webpack_require__(135);
	    ...
	    Login.prototype.render = function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'form',
	                { method: 'post', className: 'uk-grid-small', onSubmit: this.handleSubmit, 'data-uk-grid': true },
	                _react2.default.createElement(
	                    'div',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _themeVariables = __webpack_require__(109);
	...
	var _uikit3 = __webpack_require__(185);
	
	var _uikit4 = _interopRequireDefault(_uikit3);
	
	var _uikitIcons = __webpack_require__(184);
	...
	//import { UIKit } from "../lib/uikitsaveimport";
	//import UIkit from '../lib/uikit';
	
	if (typeof _uikit4.default.use === 'function') _uikit4.default.use(_uikitIcons2.default);
	...
	var Home = function (_Component) {
	    ...
	    Home.prototype.request = function request(data) {
	        var _this2 = this;
	
	        _asyncToGenerator(function* () {
	            var res = void 0;
	            try {
	                res = yield _axios2.default.post(_config.apiBaseURL + '/login', data);
	            } catch (err) {
	                _this2.setState({
	            ...
	            if (res.data.success) {
	                if (typeof window !== 'undefined') {
	                    if ((0, _storage.storageAvailable)('sessionStorage')) {
	                        window.sessionStorage.setItem('token', res.data.token);
	                        //window.document.cookie = res.data.token;
	                    } else {
	                        window.document.cookie = res.data.token;
	                    }
	                    (0, _gatsbyLink.navigateTo)('/user');
	                }
	            } else {
	                _this2.setState({ msg: res.data.msg });
	            }
	        })();
	    };
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(_Login2.default, {
	                                    onSubmitProp: function onSubmitProp(data) {
	                                        return _this3.request(data);
	                                    },
	                                    msg: this.state.msg
	                                })
	                            )
...
//# sourceMappingURL=component---src-pages-index-js-87b04d25278b6ebe7fb2.js.map